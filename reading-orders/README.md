...
This directory exists because the story is nonlinear.

Use it to guide readers through the available material without pretending the work has only one permanent structure.
